  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className='max-h-[94vh] overflow-y-auto p-0 sm:max-w-2xl'>
        <DialogHeader className='border-line bg-background/95 sticky top-0 z-10 gap-1 border-b p-4 pr-14 backdrop-blur'>
          ...
          <DialogDescription>
            ...
            connect? Send me a message and I’ll get back to you as soon as I
            can.
          </DialogDescription>
        </DialogHeader>
